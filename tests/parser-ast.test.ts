...
describe("Parser AST", () => {
  ...
  describe("Generic blocks", () => {
    ...
    it("should parse nested generic blocks", () => {
      ...
      expect(result.errors).toHaveLength(0);
      const outer = result.ast.children.find(n => n.type === "GenericBlock" && (n as any).name === "outer");
      expect(outer).toBeDefined();
      
      const inner = (outer as any).content.find((n: any) => n.type === "GenericBlock" && n.name === "inner");
  ...
  describe("Inline elements", () => {
    ...
    it("should parse generic inline", () => {
      ...
      expect(result.errors).toHaveLength(0);
      const inline = result.ast.children.find(n => n.type === "GenericInline");
...
`;
      ...
      const comment = result.ast.children.find(n => n.type === "CommentBlock");
